python3 src/command.py --map_type=google_map_sat \                                                                                                             00:32:28 
--left 116.2 --bottom 39.1 --right 116.3 --top 39.2 --max-zoom 15 --output /Users/jrontend/myPrj/tile_thief/beijing_google
